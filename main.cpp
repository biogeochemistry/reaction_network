...
double model_prob_1_rhs(double x){return 0.0;}
...
int main(int argc, char* argv[]) {
    ...
    bvpode_mp1.Solve();
    // g1.set_style("points").plot_xy(bvpode_mp1.mpGrid->mNodes,bvpode_mp1.mpSolVec);
    ...
    // bvpode_mp2.Solve();
    // g1.set_style("points").plot_xy(bvpode_mp2.mpGrid->mNodes,bvpode_mp2.mpSolVec,"user-defined points 2d");
    ...
    // bvpode_mp3.Solve();
    // g1.set_style("points").plot_xy(bvpode_mp3.mpGrid->mNodes,bvpode_mp3.mpSolVec,"user-defined points 2d");
